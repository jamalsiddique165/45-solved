...
let favoritePizza : string [] = ["peppernal pizza","colifonia pizza","BBQ chicken pizza"]

console.log("printing & sentence of pizza" );
...
console.log("\nthese are some of my favorite Pizza, and i realy love pizza in general. really love pizza" );
